...
const OnsiteOrder = () => {
    ...
    const orders = [
        { amount: '₹ 1136.00', order: '06' },
        { amount: '₹ 1089.00', order: '09' },
        { amount: '₹ 3756.00', order: '10' },
        { amount: '₹ 1689.00', order: '14' },
        { amount: '₹ 1356.00', order: '02' },
    ];
    ...
    return (
        <Container className="onsite-order">

            <Container>
                <h2 className="onsite-title text-center my-4" style={{ color: "white" }}>
                    Onsite Order
                </h2>
                <Row>
                    <div className="onsite-order" style={{ padding: "20px" }}>
                        <div className="order-items" style={{ display: "flex", gap: "35px", flexWrap: "wrap", justifyContent: "center" }}>
                                ...
                                >
                                    <div className="card-body">
                                        ...
                                        >
                                            ...
                                            <div className="order-number text-light" style={{ fontWeight: "bold" }}>
                                                {order.order}
                                            </div>
                                        </div>
                                    </div>
            ...
            <Row className="order-items">
                <h1 className="onsite-title text-center my-4" style={{ color: "white" }}>
                    Occupied
                </h1>
                        ...
                        <div key={index} className="grid-item">
                            <div className="order-item p-3 border rounded">
                                ...
                                <div
                                    ...
                                    style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}
                                >
                                    <div className="order-number fw-bold">Total Items: (02)</div>
                                ...
                                <div
                                    ...
                                    style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}
                                >
                                    <div className="amount text-muted">Total Bill:</div>
                                    <div className="text-muted fw-bold" style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>{item.amount}</div>
                                    <Card.Footer className="bill-date text-warning fs-3 text-center">{item.order}</Card.Footer>
                                </div>
            ...
            <div className="vacate-container text-center">
                <h1 style={{ color: "white", marginBottom: "20px" }}>Vacate</h1>
                <div className="grid-container">
